...
try{
	...
	{ 
        ...
        query = 'select count("DocEntry") as "Res", "DocEntry" from '+dbname+'.ORIN where "U_MSSM_CLM" = \''+claveMovil+'\' '+
                '  GROUP BY "DocEntry" ';
	    ...
	    objResult = functions.CreateJSONMessage(-100, "No se ha recibido los parámetros de entrada.");
	}
